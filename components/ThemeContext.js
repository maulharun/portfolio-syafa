// First, update ThemeContext.js to include the toggle component
// ThemeContext.js
...
export function ThemeProvider({ children }) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      // Add a class to the document body to handle theme
...
// Then, update ThemeToggle.js to use the context
// ThemeToggle.js
import { useTheme } from './ThemeContext';

export default function ThemeToggle({ position = "left" }) {
  ...
  return (
    <div
      style={{
        position: "fixed",
        bottom: "20px",
        [position]: "20px", // Use the position prop (left or right)
        zIndex: 100,
      }}
    >
      <button
...
// Now, update your Navbar component to use ThemeContext
// Navbar.js (you'll need to create or update this)
  ...
  return (
    <nav
      style={{
        ...
        alignItems: 'center',
        padding: '1rem 2rem',
        background: isDarkTheme ? 'rgba(17, 24, 39, 0.8)' : 'rgba(240, 249, 255, 0.8)',
    ...
    >
      <div className="logo" style={{ fontWeight: 'bold', fontSize: '1.5rem' }}>
        <Link href="/" style={{ color: themeStyles.accentColor, textDecoration: 'none' }}>
          Syafa
        </Link>
      </div>
      
      <div className="menu" style={{ display: 'flex', gap: '1.5rem' }}>
        <Link href="/" style={{ color: themeStyles.textColor, textDecoration: 'none' }}>
          Home
        </Link>
        <Link href="/about" style={{ color: themeStyles.textColor, textDecoration: 'none' }}>
          About
        </Link>
        <Link href="/skills" style={{ color: themeStyles.textColor, textDecoration: 'none' }}>
          Skills
        </Link>
        <Link href="/portfolio" style={{ color: themeStyles.textColor, textDecoration: 'none' }}>
          Portfolio
        </Link>
        <Link href="/contact" style={{ color: themeStyles.textColor, textDecoration: 'none' }}>
          Contact
        </Link>
      </div>
    </nav>
...
// Finally, update your page.js to use the ThemeContext
// page.js
"use client";
...
// Wrap the HomePage component with the ThemeProvider
      ...
      >
        ...
        >
            ...
            >
              ...
              <h1
                ...
                style={{
                  ...
                  fontWeight: "bold",
                  marginBottom: "1rem",
                  background: themeStyles.headingGradient,
          ...
          >
            ...
            >
              © {new Date().getFullYear()} Syafa Nur April Yanti. All rights reserved.
            </p>
          </div>
        </div>
      </div>
